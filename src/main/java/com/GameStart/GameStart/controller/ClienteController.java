...
public class ClienteController {
    ...
    @GetMapping("/clientes/buscar-por-correo")
    public ResponseEntity<Cliente> buscarPorCorreo(@RequestParam String correoCliente) {
    Cliente cliente = clienteService.findByCorreoCliente(correoCliente);
    if (cliente != null) {
        return ResponseEntity.ok(cliente);
    } else {
        return ResponseEntity.notFound().build();
